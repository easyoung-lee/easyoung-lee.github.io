...
```
!jupyter nbconvert --to markdown "/content/drive/MyDrive/Colab Notebooks/Regression으로_보스턴_부동산_가격_예측해보기 (EDA & Feature Selection).ipynb"
```

    [NbConvertApp] WARNING | pattern '/content/drive/MyDrive/Colab Notebooks/Regression으로_보스턴_부동산_가격_예측해보기 (EDA & Feature Selection).ipynb' matched no files
